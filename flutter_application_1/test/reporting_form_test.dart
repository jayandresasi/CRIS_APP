...
void main() {
  testWidgets('Reporting form shows validation errors when required fields empty', (WidgetTester tester) async {
    ...
    expect(find.text('Please enter contact person'), findsOneWidget);
